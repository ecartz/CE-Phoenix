...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Pages', 'MODULE_HEADER_TAGS_ROBOT_NOINDEX_PAGES', 'customer.php;customer_edit.php;order_history.php;order_info.php;newsletter_subscriptions.php;product_notifications.php;customer_password.php;address_book.php;address_book_process.php;checkout_confirmation.php;checkout_payment.php;checkout_payment_address.php;checkout_process.php;checkout_shipping.php;checkout_shipping_address.php;checkout_success.php;cookie_usage.php;register.php;registration_success.php;login.php;logoff.php;password_forgotten.php;password_reset.php;shopping_cart.php;ssl_check.php', 'The pages to add the meta robot noindex tag to.', '6', '0', 'page_selection::_show_pages', 'page_selection::_edit_pages(', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Pages', 'MODULE_HEADER_TAGS_DATEPICKER_JQUERY_PAGES', 'advanced_search.php;customer_edit.php;register.php', 'The pages to add the Datepicker jQuery Scripts to.', '6', '0', 'page_selection::_show_pages', 'page_selection::_edit_pages(', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_FIRSTNAME_PAGES', 'customer_edit;address_book;checkout_new_address;register;customers', 'On what pages should this appear?', '6', '5', now(), 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_STREET_ADDRESS_PAGES', 'address_book;checkout_new_address;register;customers', 'On what pages should this appear?', '6', '5', now(), 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_CITY_PAGES', 'address_book;checkout_new_address;register;customers', 'On what pages should this appear?', '6', '5', now(), 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_STATE_PAGES', 'address_book;checkout_new_address;register;customers', 'On what pages should this appear?', '6', '5', now(), 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_POST_CODE_PAGES', 'address_book;checkout_new_address;register;customers', 'On what pages should this appear?', '6', '5', now(), 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_COUNTRY_PAGES', 'address_book;checkout_new_address;register;customers', 'On what pages should this appear?', '6', '4', now(), 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_EMAIL_ADDRESS_PAGES', 'customer_edit;register;customers', 'On what pages should this appear?', '6', '5', now(), 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_PASSWORD_CONFIRMATION_PAGES', 'customer_password;register;customers', 'On what pages should this appear?', '6', '3', now(), 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_TELEPHONE_PAGES', 'customer_edit;register;customers', 'On what pages should this appear?', '6', '5', now(), 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES('Installed Modules', 'MODULE_NOTIFICATIONS_INSTALLED', 'n_checkout.php;n_register.php', 'This is automatically updated. No need to edit.', 6, 0, NOW());
