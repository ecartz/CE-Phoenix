...
*/
  ...
  $message_stack_area = 'customer_edit';
// needs to be included earlier to set the success message in the messageStack
  require "includes/languages/$language/customer_edit.php";

  if (tep_validate_form_action_is('process')) {
    $customer_details = $customer_data->process($customer_data->get_fields_for_page('customer_edit'));
    ...
    if (tep_form_processing_is_valid()) {
      ...
      $messageStack->add_session('customer', SUCCESS_ACCOUNT_UPDATED, 'success');
