<div class="col-sm-6 col-md-<?php echo $content_width; ?> cm-footer-customer">
...
?>
    <a class="nav-link pl-0" href="<?php echo tep_href_link('customer.php', '', 'SSL'); ?>"><?php echo MODULE_CONTENT_FOOTER_ACCOUNT_BOX_ACCOUNT; ?></a>
    ...
    <a class="nav-link pl-0" href="<?php echo tep_href_link('order_history.php', '', 'SSL'); ?>"><?php echo MODULE_CONTENT_FOOTER_ACCOUNT_BOX_ORDER_HISTORY; ?></a>
...
?>
    <a class="nav-link pl-0" href="<?php echo tep_href_link('register.php', '', 'SSL'); ?>"><?php echo MODULE_CONTENT_FOOTER_ACCOUNT_BOX_CREATE_ACCOUNT; ?></a>
