...
*/
  ...
  class customer {
    ...
    protected function guarantee_customer_data() {
      trigger_error('The customer->guarantee_customer_data function has been deprecated.', E_USER_DEPRECATED);
      return Guarantor::ensure_global('customer_data');
    }
    ...
    public function get_short_name() {
      trigger_error('The customer->get_short_name function has been deprecated.', E_USER_DEPRECATED);
    ...
    public function get_country_id() {
      trigger_error('The customer->get_country_id function has been deprecated.', E_USER_DEPRECATED);
      return $this->get('country_id');
    }

    public function get_zone_id() {
      trigger_error('The customer->get_zone_id function has been deprecated.', E_USER_DEPRECATED);
      return $this->get('zone_id');
    }

    public function get_all_addresses_query() {
      return tep_db_query(Guarantor::ensure_global('customer_data')->build_read(['address'], 'address_book', ['id' => (int)$this->id]));
    }
