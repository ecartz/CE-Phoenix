...
*/
  ...
  $breadcrumb->add(NAVBAR_TITLE_2, tep_href_link('newsletter_subscriptions.php', '', 'SSL'));
...
<?php echo tep_draw_form('newsletter_subscription', tep_href_link('newsletter_subscriptions.php', '', 'SSL'), 'post', '', true) . tep_draw_hidden_field('action', 'process'); ?>
