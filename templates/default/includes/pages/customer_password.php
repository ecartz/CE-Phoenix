...
*/
  ...
  $breadcrumb->add(NAVBAR_TITLE_2, tep_href_link('customer_password.php', '', 'SSL'));
...
<?php
  ...
  echo tep_draw_form('customer_password', tep_href_link('customer_password.php', '', 'SSL'), 'post', '', true) . tep_draw_hidden_field('action', 'process');
