...
*/
  ...
  $breadcrumb->add(NAVBAR_TITLE_2, tep_href_link('customer_edit.php', '', 'SSL'));
...
<?php
  ...
  echo tep_draw_form('customer_edit', tep_href_link('customer_edit.php', '', 'SSL'), 'post', '', true) . tep_draw_hidden_field('action', 'process');
?>
...
<div class="contentContainer">
  ...
  <?php
  $customer_data->display_input($customer_data->get_fields_for_page('customer_edit'), $customer->fetch_to_address());
