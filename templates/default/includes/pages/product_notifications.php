...
*/
  ...
  $breadcrumb->add(NAVBAR_TITLE_2, tep_href_link('product_notifications.php', '', 'SSL'));
...
<?php echo tep_draw_form('product_notifications', tep_href_link('product_notifications.php', '', 'SSL'), 'post', '', true) . tep_draw_hidden_field('action', 'process'); ?>
